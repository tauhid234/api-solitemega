...
class AccountModel {
    createAccount(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            let cek = yield (0, typeorm_1.getRepository)(account_entity_1.Account).findOne({ phone: req.body.phone });
            if (!cek) {
                ...
                const newAccount = (0, typeorm_1.getRepository)(account_entity_1.Account).create(body);
                const result = yield (0, typeorm_1.getRepository)(account_entity_1.Account).save(newAccount);
